...
- Multiclip Scene activation now populates and launches only eligible child-track slots, never launches or selects the aggregate group scene/sub scene, pins each exact child clip sequentially before enabling edits, and derives overlay feedback exclusively from child-track clips.
