...
- Fixed Multiclip Seq Lane Clip cursors remaining attached to the previous globally selected clip by independently pinning both observation views after every scene retarget.
