...
- Multiclip Scene activation now populates only missing child-track slots, launches the scene before retargeting Lane Clip cursors, and derives overlay feedback exclusively from child-track clips rather than group sub-scene state.
