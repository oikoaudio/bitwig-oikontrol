...
public final class DrumSettings {
    ...
    private DrumSettings(
            final SettableBooleanValue auditionOnSelect,
    ...
    public static DrumSettings from(final ControllerHost host) {
        ...
        final SettableBooleanValue auditionOnSelect =
                host.getPreferences()
                        .getBooleanSetting("Audition on drum pad select", category, true);
        final SettableBooleanValue accentMomentary =
                host.getPreferences()
                        .getBooleanSetting("Drum accent buttons momentary", category, true);
        final SettableBooleanValue showDeactivatedTracks =
                host.getPreferences().getBooleanSetting("Show deactivated tracks", category, false);
