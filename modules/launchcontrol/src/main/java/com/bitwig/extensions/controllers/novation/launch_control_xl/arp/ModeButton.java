...
public class ModeButton {
    ...
    public ModeButton(final LpcArpControlExtension driver, final Assignment assignement) {
        ...
        hwButton.pressedAction()
                .setActionMatcher(assignement.createActionMatcherPressed(driver.getMidiIn()));
        hwButton.releasedAction()
                .setActionMatcher(assignement.createActionMatcherReleaseed(driver.getMidiIn()));
        ...
        led.onUpdateHardware(
                () -> driver.sendLedUpdate(assignement, led.isOn().currentValue() ? 127 : 0));
    }
