...
public class RedGreenButton {
    ...
    public RedGreenButton(
            final LpcArpControlExtension driver,
            final String group,
            final int index,
            final int notvalue,
            final int channel) {
        ...
        hwButton.pressedAction()
                .setPressureActionMatcher(
                        driver.getMidiIn().createNoteOnVelocityValueMatcher(channel, notvalue));
        hwButton.releasedAction()
                .setActionMatcher(driver.getMidiIn().createNoteOffActionMatcher(channel, notvalue));
