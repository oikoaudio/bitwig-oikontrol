...
/**
 * Represents an single instance of an arpeggiator device. Contains and manages states that are not
 * in the device itself. These being
 *
 * <ul>
...
public class ArpInstance {
    ...
    public ArpInstance(
            ...
            final ArpParameterContainer paramContainer,
    ...
    /**
     * According to mode this returns the current note values set by base note and offset.
     *
