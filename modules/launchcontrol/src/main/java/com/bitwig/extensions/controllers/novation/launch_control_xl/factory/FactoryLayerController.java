 ...
 * The extension remains responsible for constructing layers and adapting this controller's narrow port.
 */
public final class FactoryLayerController
{
   ...
   public void selectMode(final FactoryUiSnapshot.Mode selectedMode)
   {
      ...
      switch (selectedMode)
      {
         case SEND_2_FULL_DEVICE, SEND_2_PROJECT, SEND_2_DEVICE_1, SEND_2_PAN_1 -> port.setSendBankSize(2);
   ...
   public enum TrackBooleanTarget { MUTE, SOLO, ARM }

   public enum TrackValueTarget { VOLUME, PAN }
