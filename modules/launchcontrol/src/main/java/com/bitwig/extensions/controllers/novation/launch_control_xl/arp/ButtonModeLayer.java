...
public abstract class ButtonModeLayer extends Layer {
    ...
    protected void assignStepControl(
            final RedGreenButton[] buttons,
            final Parameter steps,
    ...
    public Binding bindLightState(
            final Supplier<InternalHardwareLightState> supplier, final RedGreenButton button) {
