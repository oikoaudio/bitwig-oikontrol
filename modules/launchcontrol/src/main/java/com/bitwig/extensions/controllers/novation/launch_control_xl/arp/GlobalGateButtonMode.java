...
public class GlobalGateButtonMode extends ButtonModeLayer {
    ...
    public GlobalGateButtonMode(final LpcArpControlExtension driver, final String name) {
        ...
        assignStepControl(
                focusButtons, driver.getArpStepsParam(), driver.getArpStepPositionParam());
    ...
    private void bindButtonToValue(
            final RedGreenButton button,
            final Parameter globalGate,
            final double value,
