...
class TemplateChangeMessageParserTest {
    ...
    @Test
    void parsesUserSlot() {
        final OptionalInt slot =
                TemplateChangeMessageParser.parseUserTemplateSlot("f000202902117700f7");
    ...
    void parsesFactoryTemplateId() {
        final OptionalInt template =
                TemplateChangeMessageParser.parseTemplateId("f00020290211770cf7");
