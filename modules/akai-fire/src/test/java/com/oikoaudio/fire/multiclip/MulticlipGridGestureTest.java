...
class MulticlipGridGestureTest {
    ...
    void resolvesDocumentedModifierPrecedence() {
        assertEquals(
                MulticlipGridGesture.TIME_PAGE,
                MulticlipGridGesture.resolve(false, false, false));
        assertEquals(
                MulticlipGridGesture.HELD_STEP_NUDGE,
                MulticlipGridGesture.resolve(false, false, true));
        assertEquals(
                MulticlipGridGesture.PLAY_START,
                MulticlipGridGesture.resolve(false, true, true));
        assertEquals(
