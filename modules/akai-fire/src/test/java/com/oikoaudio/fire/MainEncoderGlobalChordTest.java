...
class MainEncoderGlobalChordTest {
    ...
    void shiftTurnMovesPlaybackStartByGrid() {
        assertEquals(
                MainEncoderGlobalChord.Action.PLAYBACK_START_GRID,
    ...
    void patternTurnMovesBetweenCueMarkers() {
        assertEquals(
                MainEncoderGlobalChord.Action.CUE_MARKER,
    ...
    void shiftPatternTurnFineMovesPlaybackStart() {
        assertEquals(
                MainEncoderGlobalChord.Action.PLAYBACK_START_FINE,
    ...
    void altChordKeepsExistingTimelineZoomBehavior() {
        assertEquals(
                MainEncoderGlobalChord.Action.TIMELINE_ZOOM_HORIZONTAL,
                MainEncoderGlobalChord.resolve(1, false, false, false, true));
        assertEquals(
                MainEncoderGlobalChord.Action.TIMELINE_ZOOM_VERTICAL,
    ...
    void ignoresZeroIncrementsAndPopupBrowserTurns() {
        assertEquals(
                MainEncoderGlobalChord.Action.NONE,
