...
class PerformPadRendererTest {
    ...
    void launcherSlotsCoverMissingEmptyQueuedPlayingAndRecordingStates() {
        ...
        assertEquals(COLOR.getBrightest(),
                PerformPadRenderer.slot(new PerformPadRenderer.SlotSnapshot(true, true, false,
                        true, false, false, false, false, COLOR), 0));
        assertEquals(COLOR.getDimmed(),
                PerformPadRenderer.slot(new PerformPadRenderer.SlotSnapshot(true, true, false,
                        false, true, false, false, false, COLOR), 1));
        assertEquals(COLOR.getBrightend(),
                PerformPadRenderer.slot(new PerformPadRenderer.SlotSnapshot(true, true, false,
                        false, false, true, false, false, COLOR), 0));
        assertEquals(COLOR.getBrightest(),
                PerformPadRenderer.slot(new PerformPadRenderer.SlotSnapshot(true, true, true,
                        false, false, false, false, true, COLOR), 0));
    }
    ...
    void sceneLaunchCoversUnavailablePendingSelectedRecordingAndPlayingStates() {
        ...
        assertEquals(COLOR.getBrightest(),
                PerformPadRenderer.scene(new PerformPadRenderer.SceneSnapshot(true, COLOR,
    ...
    void mixRowsCoverSelectionQueueSoloMuteArmAndMissingTracks() {
        ...
        assertEquals(COLOR.getBrightest(), PerformPadRenderer.trackAction(
                new PerformPadRenderer.TrackSnapshot(PerformPadRenderer.TrackAction.SELECT, true, COLOR,
                        true, false, false, false, false, false), 0));
        assertEquals(COLOR.getDimmed(), PerformPadRenderer.trackAction(
                new PerformPadRenderer.TrackSnapshot(PerformPadRenderer.TrackAction.SELECT, true, COLOR,
                        false, true, true, false, false, false), 1));
        assertEquals(PerformPadRenderer.TrackAction.SOLO.color().getBrightest(), PerformPadRenderer.trackAction(
                new PerformPadRenderer.TrackSnapshot(PerformPadRenderer.TrackAction.SOLO, true, COLOR,
                        false, false, false, true, false, false), 0));
        assertEquals(PerformPadRenderer.TrackAction.MUTE.color().getDimmed(), PerformPadRenderer.trackAction(
                new PerformPadRenderer.TrackSnapshot(PerformPadRenderer.TrackAction.MUTE, true, COLOR,
                        false, false, false, false, false, false), 0));
        assertEquals(PerformPadRenderer.TrackAction.ARM.color(), PerformPadRenderer.trackAction(
                new PerformPadRenderer.TrackSnapshot(PerformPadRenderer.TrackAction.ARM, true, COLOR,
