...
class BrowserTransportControlsTest {
    ...
    void playCommitsPopupBrowserWhenBrowserIsActive() {
        assertEquals(AkaiFireOikontrolExtension.BrowserTransportAction.COMMIT,
    ...
    void stopCancelsPopupBrowserWhenBrowserIsActive() {
        assertEquals(AkaiFireOikontrolExtension.BrowserTransportAction.CANCEL,
    ...
    void browserTransportRoutingIgnoresReleaseAndInactiveBrowser() {
        assertEquals(AkaiFireOikontrolExtension.BrowserTransportAction.NONE,
