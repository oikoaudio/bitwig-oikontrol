...
class ClipRowActionResolverTest {
    ...
    void ignoresReleasedPads() {
        assertEquals(
                ClipRowActionResolver.Action.IGNORE,
    ...
    void launchesExistingClipByDefault() {
        assertEquals(
                ClipRowActionResolver.Action.SELECT_AND_LAUNCH,
    ...
    void createsEmptyClipOnEmptySlotByDefault() {
        assertEquals(
                ClipRowActionResolver.Action.CREATE_EMPTY,
    ...
    void selectsWithoutLaunchWhenSelectHeld() {
        assertEquals(
                ClipRowActionResolver.Action.SELECT_ONLY,
    ...
    void clearsStepsWhenDeleteHeld() {
        assertEquals(
                ClipRowActionResolver.Action.CLEAR_STEPS,
    ...
    void deletesObjectWhenShiftDeleteHeld() {
        assertEquals(
                ClipRowActionResolver.Action.DELETE_OBJECT,
    ...
    void copiesIntoDifferentExistingSlot() {
        assertEquals(
                ClipRowActionResolver.Action.COPY_TO_TARGET,
    ...
    void cyclesColorOnShiftPress() {
        assertEquals(
                ClipRowActionResolver.Action.CYCLE_COLOR,
