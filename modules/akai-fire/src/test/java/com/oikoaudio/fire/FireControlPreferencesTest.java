...
class FireControlPreferencesTest {
    ...
    void mapsLaunchQuantizationPreferenceValues() {
        assertEquals(
                "none",
                FireControlPreferences.toLaunchQuantizationValue(
                        FireControlPreferences.QUANTIZATION_NONE));
        assertEquals(
                "1/4",
                FireControlPreferences.toLaunchQuantizationValue(
                        FireControlPreferences.QUANTIZATION_1_4));
    ...
    void normalizesMainEncoderRolePreferenceValues() {
        assertEquals(
                ...
                FireControlPreferences.normalizeMainEncoderRole(
                        FireControlPreferences.MAIN_ENCODER_LAST_TOUCHED));
        assertEquals(
                ...
                FireControlPreferences.normalizeMainEncoderRole(
                        FireControlPreferences.MAIN_ENCODER_SHUFFLE));
        assertEquals(
                FireControlPreferences.MAIN_ENCODER_TEMPO,
                FireControlPreferences.normalizeMainEncoderRole(
                        FireControlPreferences.MAIN_ENCODER_TEMPO));
        assertEquals(
    ...
    void normalizesStartupModePreferenceValues() {
        assertEquals(
                ...
                FireControlPreferences.normalizeStartupMode(
                        FireControlPreferences.STARTUP_MODE_NOTE));
        assertEquals(
                FireControlPreferences.STARTUP_MODE_HARMONY,
                FireControlPreferences.normalizeStartupMode(
                        FireControlPreferences.STARTUP_MODE_HARMONY));
        assertEquals(
                FireControlPreferences.STARTUP_MODE_DRUM_XOX,
                FireControlPreferences.normalizeStartupMode(
                        FireControlPreferences.STARTUP_MODE_DRUM_XOX));
        assertEquals(
                FireControlPreferences.STARTUP_MODE_LAUNCHER,
                FireControlPreferences.normalizeStartupMode(
                        FireControlPreferences.STARTUP_MODE_LAUNCHER));
        assertEquals(
                FireControlPreferences.STARTUP_MODE_MIX,
                FireControlPreferences.normalizeStartupMode(
                        FireControlPreferences.STARTUP_MODE_MIX));
        assertEquals(
                FireControlPreferences.STARTUP_MODE_NOTE,
    ...
    void normalizesDrumPinModes() {
        assertEquals(
                ...
                FireControlPreferences.normalizeDrumPinMode(
                        FireControlPreferences.DRUM_PIN_MODE_FOLLOW_SELECTION));
        assertEquals(
    ...
    void normalizesScreenMessageHoldPreferenceValues() {
        assertEquals(
                FireControlPreferences.SCREEN_MESSAGE_HOLD_SHORT,
                FireControlPreferences.normalizeScreenMessageHold(
                        FireControlPreferences.SCREEN_MESSAGE_HOLD_SHORT));
        assertEquals(
                ...
                FireControlPreferences.normalizeScreenMessageHold(
                        FireControlPreferences.SCREEN_MESSAGE_HOLD_NORMAL));
        assertEquals(
                FireControlPreferences.SCREEN_MESSAGE_HOLD_LONG,
                FireControlPreferences.normalizeScreenMessageHold(
                        FireControlPreferences.SCREEN_MESSAGE_HOLD_LONG));
        assertEquals(
                FireControlPreferences.SCREEN_MESSAGE_HOLD_NORMAL,
    ...
    void detectsWhenPlaybackNotesShouldUseNoteChordDisplay() {
        ...
        assertEquals(
                ...
                FireControlPreferences.shouldShowPlaybackNoteChordDisplay(
                        FireControlPreferences.NOTE_CHORD_DISPLAY_PADS_AND_DAW));
        assertEquals(
                false, FireControlPreferences.shouldShowPlaybackNoteChordDisplay("unexpected"));
    }
    ...
    void mapsScreenMessageHoldPreferenceValuesToMilliseconds() {
        assertEquals(
                750,
                FireControlPreferences.toScreenMessageHoldMillis(
                        FireControlPreferences.SCREEN_MESSAGE_HOLD_SHORT));
        assertEquals(
                1500,
                FireControlPreferences.toScreenMessageHoldMillis(
    ...
    void detectsWhenDrumModeShouldAutoPinFirstDrumMachine() {
        ...
        assertEquals(
                ...
                FireControlPreferences.shouldAutoPinFirstDrumMachine(
                        FireControlPreferences.DRUM_PIN_MODE_FOLLOW_SELECTION));
        assertEquals(true, FireControlPreferences.shouldAutoPinFirstDrumMachine("unexpected"));
    }
    ...
    void normalizesPerformClipLauncherLayoutPreferenceValues() {
        assertEquals(
                ...
                FireControlPreferences.normalizePerformLayout(
                        FireControlPreferences.PERFORM_LAYOUT_VERTICAL));
        assertEquals(
                FireControlPreferences.PERFORM_LAYOUT_HORIZONTAL,
                FireControlPreferences.normalizePerformLayout(
                        FireControlPreferences.PERFORM_LAYOUT_HORIZONTAL));
        assertEquals(
                FireControlPreferences.PERFORM_LAYOUT_VERTICAL,
    ...
    void normalizesDefaultClipLengthPreferenceValues() {
        assertEquals(
                FireControlPreferences.CLIP_LENGTH_1_BAR,
        ...
        assertEquals(
                ...
                FireControlPreferences.normalizeDefaultClipLength(
                        FireControlPreferences.CLIP_LENGTH_2_BARS));
        assertEquals(
                FireControlPreferences.CLIP_LENGTH_4_BARS,
                FireControlPreferences.normalizeDefaultClipLength(
                        FireControlPreferences.CLIP_LENGTH_4_BARS));
        assertEquals(
                FireControlPreferences.CLIP_LENGTH_8_BARS,
                FireControlPreferences.normalizeDefaultClipLength(
                        FireControlPreferences.CLIP_LENGTH_8_BARS));
        assertEquals(
                FireControlPreferences.CLIP_LENGTH_2_BARS,
                FireControlPreferences.normalizeDefaultClipLength(
                        FireControlPreferences.CLIP_LENGTH_OFF));
        assertEquals(
                FireControlPreferences.CLIP_LENGTH_2_BARS,
                FireControlPreferences.normalizeDefaultClipLength(
    ...
    void normalizesLauncherRecordLengthPreferenceValues() {
        assertEquals(
                ...
                FireControlPreferences.normalizeLauncherRecordLength(
                        FireControlPreferences.CLIP_LENGTH_OFF));
        assertEquals(
    ...
    void mapsDefaultClipLengthPreferenceToBeats() {
        ...
        assertEquals(
                8.0,
                FireControlPreferences.toClipLengthBeats(
                        FireControlPreferences.CLIP_LENGTH_2_BARS));
        assertEquals(
                16.0,
                FireControlPreferences.toClipLengthBeats(
    ...
    void detectsRoundLauncherRecordLengthPreference() {
        assertEquals(
                ...
                FireControlPreferences.isRoundLauncherRecordLength(
                        FireControlPreferences.CLIP_LENGTH_ROUND_NEAREST_BAR));
        assertEquals(
                true, FireControlPreferences.isRoundLauncherRecordLength("Round to nearest bar"));
        assertEquals(
                false,
                FireControlPreferences.isRoundLauncherRecordLength(
                        FireControlPreferences.CLIP_LENGTH_2_BARS));
    ...
    void detectsManualLauncherRecordLengthPreference() {
        assertEquals(
                true,
                FireControlPreferences.isManualLauncherRecordLength(
                        FireControlPreferences.CLIP_LENGTH_OFF));
        assertEquals(
                false,
                FireControlPreferences.isManualLauncherRecordLength(
    ...
    void normalizesDefaultRootKeyPreferenceValues() {
        assertEquals(
                ...
                FireControlPreferences.normalizeDefaultRootKey(
                        FireControlPreferences.DEFAULT_ROOT_KEY));
        assertEquals("F#", FireControlPreferences.normalizeDefaultRootKey("F#"));
        assertEquals(
                FireControlPreferences.DEFAULT_ROOT_KEY,
