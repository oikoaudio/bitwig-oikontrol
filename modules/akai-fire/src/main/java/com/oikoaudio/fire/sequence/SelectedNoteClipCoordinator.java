...
public final class SelectedNoteClipCoordinator {
    ...
    public SelectedNoteClipCoordinator(
            final ClipLauncherSlotBank slotBank,
            final RgbLightState defaultColor,
            final BooleanSupplier canHoldNoteData,
            final IntSupplier viewSelectedSlot,
    ...
    public void observe(final boolean includeColor, final boolean includePlaybackState) {
        SelectedClipSlotObserver.observe(
                slotBank, includeColor, includePlaybackState, this::refreshState);
    }
    ...
    public boolean refreshCursor() {
        return NoteClipCursorRefresher.refresh(
                slotBank,
                viewSelectedSlot.getAsInt(),
                this::refreshState,
                () -> state.slotIndex(),
                cursorResetActions);
    }
    ...
    public void scheduleRefresh(
            final Scheduler scheduler, final long delayMs, final Runnable completion) {
