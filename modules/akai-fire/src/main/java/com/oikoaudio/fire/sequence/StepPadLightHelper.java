...
public final class StepPadLightHelper {
    ...
    public static RgbLightState renderOccupiedStep(final RgbLightState base, final boolean accented,
    ...
    public static RgbLightState renderClipStartColumnOverlay(final int padColumn,
