...
final class ArrangerGridStep {
    private static final double[] ZOOM_LIMITS = {
        8.8, 27.94, 279.11, 661.61, 1176.20, 2091.03, 4956.52, 8811.59, 20886.75, 37132.00,
        66012.45, 156473.96, 278175.93, 600000.0, 800000.0
    };
    ...
    static double fromContentPerPixel(
            final double contentPerPixel, final int numerator, final int denominator) {
