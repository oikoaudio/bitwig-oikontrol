 ...
 *
 * <p>The Akai Fire mode buttons expose a small button LED state set rather than arbitrary RGB
 * colors, so mode slots must use visibly distinct hardware states.
 */
public final class ModeButtonLights {
    ...
    public static final BiColorLightState MODE_4 = BiColorLightState.AMBER_HALF;
