...
final class PhraseContourLibrary {
    ...
    record ContourTemplate(
            String name,
            ContourAction[] actions,
            int[] anchorDegrees,
            int[] coreDegrees,
            int[] colorDegrees,
            int[] cadenceDegrees) {
    ...
    private static final ContourTemplate[] ACID_BASES = {
        new ContourTemplate(
                "FundamentalPulse",
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.NEIGHBOR,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REPEAT, ContourAction.REST,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.NEIGHBOR,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.OCTAVE, ContourAction.CADENCE,
                            ContourAction.REST
                },
                new int[] {0, 0, 0, 2},
                new int[] {0, 1, 2, 4},
        ...
        new ContourTemplate(
                ...
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.NEIGHBOR,
                            ContourAction.REPEAT,
                    ContourAction.REST, ContourAction.ANCHOR, ContourAction.PICKUP,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.NEIGHBOR,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.OCTAVE, ContourAction.CADENCE,
        ...
        new ContourTemplate(
                "OctaveLead",
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.OCTAVE,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.NEIGHBOR, ContourAction.REST,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.OCTAVE,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.NEIGHBOR, ContourAction.CADENCE,
                            ContourAction.REST
                },
                new int[] {0, 0, 2},
                new int[] {0, 1, 2, 4},
        ...
        new ContourTemplate(
                "SupportCadence",
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.REST,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.LEAP, ContourAction.REST,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.NEIGHBOR, ContourAction.REPEAT,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.OCTAVE, ContourAction.CADENCE,
                            ContourAction.REST
                },
        ...
        new ContourTemplate(
                ...
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.PICKUP, ContourAction.NEIGHBOR,
                            ContourAction.REPEAT,
                    ContourAction.REST, ContourAction.REST, ContourAction.ANCHOR,
                            ContourAction.PICKUP,
                    ContourAction.NEIGHBOR, ContourAction.REPEAT, ContourAction.REST,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.OCTAVE, ContourAction.CADENCE,
                            ContourAction.REST
                },
    ...
    private static final ContourTemplate[] MOTIF_BASES = {
        new ContourTemplate(
                "RepeatAnswer",
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.STEP,
                            ContourAction.REPEAT,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.PICKUP,
                            ContourAction.REPEAT,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.STEP,
                            ContourAction.REPEAT,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.CADENCE,
                            ContourAction.REPEAT
                },
                new int[] {0, 2, 4},
                new int[] {0, 1, 2, 3, 4, 5},
        ...
        new ContourTemplate(
                "CallResponse",
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.NEIGHBOR,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.LEAP,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.NEIGHBOR,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.CADENCE,
        ...
        new ContourTemplate(
                "StaticPerturb",
                new ContourAction[] {
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.REPEAT,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.NEIGHBOR,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.REPEAT,
        ...
        new ContourTemplate(
                ...
                new ContourAction[] {
                    ...
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.REPEAT,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.OCTAVE,
                            ContourAction.REST,
                    ContourAction.ANCHOR, ContourAction.REST, ContourAction.CADENCE,
                            ContourAction.REST
                },
    ...
    static ContourBlueprint acidBlueprint(
            final int loopSteps, final Random random, final double density, final double tension) {
        return compose(loopSteps, random, density, tension, ACID_BASES, ACID_OVERLAYS);
    }

    static ContourBlueprint motifBlueprint(
            final int loopSteps, final Random random, final double density, final double tension) {
        return compose(loopSteps, random, density, tension, MOTIF_BASES, MOTIF_OVERLAYS);
    }

    private static ContourBlueprint compose(
            final int loopSteps,
            final Random random,
            final double density,
            final double tension,
            final ContourTemplate[] templates,
        ...
        for (int step = 0; step < loopSteps; step++) {
            ...
            final boolean preserveBase =
                    base == ContourAction.ANCHOR || base == ContourAction.CADENCE;
            ContourAction action = base;
            if (!preserveBase
                    && detail != ContourAction.REST
                    && random.nextDouble() < overlayChance) {
                action = detail;
            }
    ...
    private static boolean retainedByDensity(
            final ContourAction action,
            final int densityTier,
            final int step,
            final int loopSteps) {
