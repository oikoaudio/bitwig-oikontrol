...
public final class BankButtonBindings {
    ...
    public static void bind(final Layer layer, final BiColorButton leftButton, final BiColorButton rightButton,
                            final Host host) {
        leftButton.bindPressed(layer, pressed -> host.handleBankButton(pressed, -1), host::bankLightState);
        rightButton.bindPressed(layer, pressed -> host.handleBankButton(pressed, 1), host::bankLightState);
    }
