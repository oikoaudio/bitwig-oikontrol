...
/** Owns the Melodic Step encoder-bank layout while shared mechanics remain in StepSequencerEncoderLayer. */
public final class MelodicStepEncoderControls {
    private final EncoderBankLayout layout;

    public MelodicStepEncoderControls(final EncoderSlotBinding[] channel,
        ...
        banks.put(EncoderMode.CHANNEL, new EncoderBank(
                "1: Engine\n2: Density\n3: Pool Oct\n4: Mut Type",
                EncoderFooterLegend.of("Engn", "Dens", "Pool", "MutT"), channel));
        banks.put(EncoderMode.MIXER, new EncoderBank(
                "1: Length\n2: Swivel / Mirror x2\n3: Reverse\n4: Invert", mixer));
        banks.put(EncoderMode.USER_1, new EncoderBank(
                "1: Velocity\n2: Pressure\n3: Timbre\n4: Pitch",
                EncoderFooterLegend.of("Velo", "Pres", "Timb", "Ptch"), user1));
        banks.put(EncoderMode.USER_2, new EncoderBank(
                "1: Gate Len\n2: Chance\n3: Vel Spread\n4: Repeat",
                EncoderFooterLegend.of("GLen", "Chnc", "VSpr", "Rpt"), user2));
