    ...
    private EncoderSlotBinding chordBuildVelocitySlot() {
        return new EncoderSlotBinding() {
            ...
            public void bind(final StepSequencerEncoderLayer handler, final Layer layer, final TouchEncoder encoder,
                ...
                encoder.bindTouched(layer, touched -> {
                    if (touched) {
                        if (driver.handleKnobModeEncoderReset(true, true, "Velocity", "No reset here",
    ...
    private EncoderSlotBinding chordSlot(final int slotIndex, final EncoderStepAccumulator accumulator,
        ...
        return new EncoderSlotBinding() {
            ...
            public void bind(final StepSequencerEncoderLayer handler, final Layer layer, final TouchEncoder encoder,
                ...
                encoder.bindTouched(layer, touched -> {
                    if (touched) {
                        if (driver.handleKnobModeEncoderReset(true, true, "Chord", "No reset here", () -> {
                            accumulator.reset();
                            resetAction.run();
                        }, showInfo)) {
                            return;
        ...
        return new EncoderSlotBinding() {
            ...
            public void bind(final StepSequencerEncoderLayer handler, final Layer layer, final TouchEncoder encoder,
                ...
                encoder.bindTouched(layer, touched -> {
                    if (touched) {
                        if (driver.isGlobalShiftHeld()) {
                            if (driver.handleKnobModeEncoderReset(true, false, "Scale", "No reset here",
                        ...
                        if (driver.isGlobalAltHeld()) {
                            if (driver.handleKnobModeEncoderReset(true, false, "Invert", "No reset here",
                        ...
                        if (driver.handleKnobModeEncoderReset(true, true, "Interpret", "No reset here",
