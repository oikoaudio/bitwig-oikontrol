...
public final class MusicalScaleLibrary {
    private MusicalScaleLibrary() {
        ...
        for (int i = 0; i < numScales; ++i) mScalesName[i] = mMusicalScales.get(i).getName();
    }
    ...
    public static MusicalScaleLibrary getInstance() {
        return mInstance;
    }
    ...
    public final MusicalScale getMusicalScale(final int index) {
        if (index < 0 || index >= mMusicalScales.size()) return null;
