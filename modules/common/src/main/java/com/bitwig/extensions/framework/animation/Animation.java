...
public abstract class Animation<ValueType> implements Supplier<ValueType> {
    ...
    private static void pumpFlush(
            final ControllerHost host, final List<Animation> runningAnimations) {
        host.requestFlush();
    ...
    private static final Map<ControllerHost, List<Animation>> HOST_TO_RUNNING_ANIMATIONS_MAP =
            new HashMap<>();
}
