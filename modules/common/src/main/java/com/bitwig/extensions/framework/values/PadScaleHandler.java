...
public class PadScaleHandler {
    ...
    public PadScaleHandler(
            final ControllerHost host,
            final List<IScale> includedScales,
            final int padCount,
        ...
        if (scaleToDocumentState) {
            scaleAssignment =
                    documentState.getEnumSetting(
                            "Pad Scale", //
                            "Pads",
                            scales.stream().map(IScale::getName).toArray(String[]::new),
                            scales.get(0).getName());
            ...
            baseNotesAssignment =
                    documentState.getEnumSetting(
                            "Base Note", //
                            "Pads",
                            baseNotes.stream().toArray(String[]::new),
                            baseNotes.get(0));
