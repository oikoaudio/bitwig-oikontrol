...
public abstract class Binding<SourceType, TargetType> {
    protected Binding(
            final Object exclusivityObject, final SourceType source, final TargetType target) {
        super();
    ...
    /**
     * Object that represents an exclusive source for binding purposes. If 2 layers use the same
     * exclusivity object for a binding then all bindings in the lower layer with that object will
     * be inactive.
     */
