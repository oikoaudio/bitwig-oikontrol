...
public abstract class AbstractRelativeHardwareControlBinding<
                TargetType extends RelativeHardwarControlBindable,
                HardwareBindingType extends
                        com.bitwig.extension.controller.api.RelativeHardwareControlBinding>
    ...
    public AbstractRelativeHardwareControlBinding(
            final RelativeHardwareControl source, final TargetType target) {
        super(source, target);
    }
    ...
    private void updateEffectiveSensitivity() {
        if (isActive()) getHardwareBinding().setSensitivity(mSensitivity * mGlobalSensitivity);
    }
