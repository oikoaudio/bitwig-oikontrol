...
public abstract class HardwareBinding<
                SourceType extends HardwareBindingSource,
                TargetType extends HardwareBindable,
                HardwareBindingType extends com.bitwig.extension.controller.api.HardwareBinding>
        extends Binding<SourceType, TargetType> {
    protected HardwareBinding(
            final Object exclusiveSource, final SourceType source, final TargetType target) {
