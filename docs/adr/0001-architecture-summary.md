...
- Hosts must run Bitwig Studio 6.0+ (API 25+). Bitwig 6 runs on JDK 25, and we use a JDK 25 build toolchain while emitting Java 21-compatible extension classes.
